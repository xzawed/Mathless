...
| **X3** | ✅ **닫힘 (2026-09-25)** — §4-9 후반 · §4-10 일부 | Wiki는 껐다(2026-09-07) · 포크 PR 승인 정책은 기본값 `first_time_contributors`를 유지한다(② 2026-09-24, 사용자 확인) · 계정 Emails 설정은 켜 두었다(① 2026-09-25, 사용자 확인 — 근거 수준은 사용자 보고다). 홈페이지 URL은 §4-5. 경위 → [`history/status-9.md`](history/status-9.md) |
